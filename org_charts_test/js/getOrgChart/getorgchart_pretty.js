...
getOrgChart.prototype._aH=function(){
    ...
    switch(this.config.orientation){
        case getOrgChart.RO_TOP:case getOrgChart.RO_TOP_PARENT_LEFT:case getOrgChart.RO_LEFT:case getOrgChart.RO_LEFT_PARENT_TOP:this._a8=this.config.topXAdjustment+this._a7._zW;
        this._a9=this.config.topYAdjustment+this._a7._zS;
        break;
        case getOrgChart.RO_BOTTOM:case getOrgChart.RO_BOTTOM_PARENT_LEFT:case getOrgChart.RO_RIGHT:case getOrgChart.RO_RIGHT_PARENT_TOP:this._a8=this.config.topXAdjustment+this._a7._zW;
        this._a9=this.config.topYAdjustment+this._a7._zS
    }
...
getOrgChart.prototype._L=function(a){
    switch(this.config.orientation){
        case getOrgChart.RO_TOP:case getOrgChart.RO_TOP_PARENT_LEFT:case getOrgChart.RO_BOTTOM:case getOrgChart.RO_BOTTOM_PARENT_LEFT:return a.w;
        case getOrgChart.RO_RIGHT:case getOrgChart.RO_RIGHT_PARENT_TOP:case getOrgChart.RO_LEFT:case getOrgChart.RO_LEFT_PARENT_TOP:return a.h
    }
        ...
        switch(this.render){
            ...
            for(themeProperty in this.theme){
                switch(themeProperty){
                    ...
                    break;
                    case"box":f.push(this.theme.box);
                    break;
                    case"text":var g=0;
                    for(k=0;
                    k&lt;
                    this.config.primaryColumns.length;
                    k++){
                        var e=h[g];
            ...
            this._S("renderBoxContentEvent",{
                id:d.id,parentId:d.pid,data:d.data,boxContentElements:f
            }
...
getOrgChart.prototype._a5=function(){
    ...
    switch(this.render){
        case"SVG":a.push(getOrgChart.OPEN_SVG.replace("[defs]",this.config.embededDefinitions).replace("[viewBox]",b.toString()));
        a.push(this._p());
...
getOrgChart.prototype._4=function(){
    if(this.config.scale==="auto"){
        ...
        switch(this.config.orientation){
            case getOrgChart.RO_TOP:case getOrgChart.RO_TOP_PARENT_LEFT:this.initialViewBoxMatrix=[-g,h,f,a];
            break;
            case getOrgChart.RO_BOTTOM:case getOrgChart.RO_BOTTOM_PARENT_LEFT:this.initialViewBoxMatrix=[-g,-h-a,f,a];
            break;
            case getOrgChart.RO_RIGHT:case getOrgChart.RO_RIGHT_PARENT_TOP:this.initialViewBoxMatrix=[-f-h,-g,f,a];
            break;
            case getOrgChart.RO_LEFT:case getOrgChart.RO_LEFT_PARENT_TOP:this.initialViewBoxMatrix=[h,-g,f,a];
            break
        }
...
getOrgChart.prototype._al=function(b,a){
    switch(b){
        case this._Q._a6:this.move("right");
        break;
        case this._Q._ay:this.move("left");
        break;
        case this._Q._o:this.move("up");
        break;
        case this._Q._zo:this.move("down");
        break
    }
...
getOrgChart.INNER_HTML='<div class="get-[theme] get-[color] get-org-chart"><div class="get-oc-tb"><div><div style="height:[toolbar-height]px;
">&lt;
input placeholder="Search" type="text" /&gt;
<a title="previous" class="get-prev get-disabled" href="javascript:void(0)">&nbsp;
</a><a title="next" class="get-next get-disabled" href="javascript:void(0)">&nbsp;
</a><a class="get-minus" title="zoom out" href="javascript:void(0)">&nbsp;
</a><a class="get-plus" title="zoom in" href="javascript:void(0)">&nbsp;
</a><a class="get-right" title="move right" href="javascript:void(0)">&nbsp;
</a><a class="get-left" title="move left" href="javascript:void(0)">&nbsp;
</a><a class="get-down" title="move down" href="javascript:void(0)">&nbsp;
</a><a class="get-up" title="move up" href="javascript:void(0)">&nbsp;
</a><a class="get-add" title="add contact" href="javascript:void(0)">&nbsp;
</a><a href="javascript:void(0)" class="get-grid-view" title="grid view">&nbsp;
</a><a href="javascript:void(0)" class="get-print" title="print">&nbsp;
</a></div><div style="height:[toolbar-height]px;
"><a title="previous page" class="get-prev-page" href="javascript:void(0)">&nbsp;
</a><a title="delete" class="get-delete" href="javascript:void(0)">&nbsp;
</a><a title="save" class="get-save get-disabled" href="javascript:void(0)">&nbsp;
</a></div><div style="height:[toolbar-height]px;
"><a title="previous page" class="get-prev-page" href="javascript:void(0)">&nbsp;
</a></div></div></div><div class="get-oc-c" style="height:[height]px;
"></div><div class="get-oc-v" style="height:[height]px;
"><div class="get-image-pane"></div><div class="get-data-pane"></div></div><div class="get-oc-g" style="height:[height]px;
"></div></div>';
getOrgChart.DETAILS_VIEW_INPUT_HTML='<div data-field-name="[label]"><div class="get-label">[label]</div><div class="get-data">&lt;
input value="[value]"/&gt;
</div></div>';
getOrgChart.DETAILS_VIEW_USER_LOGO='&lt;
svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" width="512px" height="512px" viewBox="0 0 640 640" enable-background="new 0 0 420 420" xml:space="preserve" xmlns:xml="http://www.w3.org/XML/1998/namespace" class="get-user-logo"&gt;
&lt;
g&gt;
&lt;
path class="get-user-logo" d="M258.744,293.214c70.895,0,128.365-57.472,128.365-128.366c0-70.896-57.473-128.367-128.365-128.367 c-70.896,0-128.368,57.472-128.368,128.367C130.377,235.742,187.848,293.214,258.744,293.214z"/&gt;
&lt;
...
/svg&gt;
';
getOrgChart.DETAILS_VIEW_ID_INPUT='&lt;
input value="[personId]" type="hidden"&gt;
&lt;
/input&gt;
';
...
getOrgChart.W = '<a style="display: block !important;
position: absolute !important;
bottom: 15px !important;
right: 15px !important;
color: rgb(172, 25, 61) !important;
width: auto;
height!important;
: auto !important;
...
" title="GetOrgChart jquery plugin" target="_blank" href="http://getorgchart.com">GetOrgChart</a></div>';
...
getOrgChart.OPEN_SVG='&lt;
svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" version="1.1" viewBox="[viewBox]"&gt;
&lt;
defs&gt;
[defs]&lt;
/defs&gt;
...
g&gt;
';
getOrgChart.CLOSE_SVG="&lt;
/svg&gt;
";
getOrgChart.OPEN_GROUP='&lt;
g class="get-level-[level]" title="click here to see more details" transform="matrix(1,0,0,1,[x],[y])"&gt;
';
getOrgChart.CLOSE_GROUP="&lt;
/g&gt;
";
...
getOrgChart._zd=function(h,d,b,j,l){
    ...
    =h.config.maxDepth){
        ...
        switch(h.config.orientation){
            case getOrgChart.RO_TOP:case getOrgChart.RO_TOP_PARENT_LEFT:case getOrgChart.RO_BOTTOM:case getOrgChart.RO_BOTTOM_PARENT_LEFT:c=h._au[b];
            e=d.h;
            break;
            case getOrgChart.RO_RIGHT:case getOrgChart.RO_RIGHT_PARENT_TOP:case getOrgChart.RO_LEFT:case getOrgChart.RO_LEFT_PARENT_TOP:c=h._aj[b];
            a=true;
            e=d.w;
            break
        }
        ...
        switch(h.config.nodeJustification){
            case getOrgChart.NJ_TOP:d._zW=k;
            d._zS=m;
            break;
            case getOrgChart.NJ_CENTER:d._zW=k;
            d._zS=m+(c-e)/2;
            break;
            case getOrgChart.NJ_BOTTOM:d._zW=k;
            d._zS=(m+c)-e;
            break
        }
        ...
        switch(h.config.orientation){
            case getOrgChart.RO_BOTTOM:case getOrgChart.RO_BOTTOM_PARENT_LEFT:d._zS=-d._zS-e;
            break;
            case getOrgChart.RO_RIGHT:case getOrgChart.RO_RIGHT_PARENT_TOP:d._zW=-d._zW-e;
            break
        }
...
getOrgChart.person.prototype._l=function(d){
    ...
    switch(d.config.orientation){
        case getOrgChart.RO_TOP:case getOrgChart.RO_TOP_PARENT_LEFT:e=this._zW+(this.w/2);
        i=this._zS+this.h;
        break;
        case getOrgChart.RO_BOTTOM:case getOrgChart.RO_BOTTOM_PARENT_LEFT:e=this._zW+(this.w/2);
        i=this._zS;
        break;
        case getOrgChart.RO_RIGHT:case getOrgChart.RO_RIGHT_PARENT_TOP:e=this._zW;
        i=this._zS+(this.h/2);
        break;
        case getOrgChart.RO_LEFT:case getOrgChart.RO_LEFT_PARENT_TOP:e=this._zW+this.w;
        i=this._zS+(this.h/2);
        break
    }
    ...
    a++){
        b=this._aZ[a];
        switch(d.config.orientation){
            case getOrgChart.RO_TOP:case getOrgChart.RO_TOP_PARENT_LEFT:h=g=b._zW+(b.w/2);
            m=b._zS;
            f=e;
            switch(d.config.nodeJustification){
                case getOrgChart.NJ_TOP:j=l=m-d.config.levelSeparation/2;
                break;
                case getOrgChart.NJ_BOTTOM:j=l=i+d.config.levelSeparation/2;
                break;
                case getOrgChart.NJ_CENTER:j=l=i+(m-i)/2;
                break
            }
            
            break;
            case getOrgChart.RO_BOTTOM:case getOrgChart.RO_BOTTOM_PARENT_LEFT:h=g=b._zW+(b.w/2);
            m=b._zS+b.h;
            f=e;
            switch(d.config.nodeJustification){
                case getOrgChart.NJ_TOP:j=l=m+d.config.levelSeparation/2;
                ...
                case getOrgChart.NJ_BOTTOM:j=l=i-d.config.levelSeparation/2;
                break;
                case getOrgChart.NJ_CENTER:j=l=m+(i-m)/2;
                break
            }
            
            break;
            case getOrgChart.RO_RIGHT:case getOrgChart.RO_RIGHT_PARENT_TOP:h=b._zW+b.w;
            m=l=b._zS+(b.h/2);
            j=i;
            switch(d.config.nodeJustification){
                case getOrgChart.NJ_TOP:f=g=h+d.config.levelSeparation/2;
                break;
                case getOrgChart.NJ_BOTTOM:f=g=e-d.config.levelSeparation/2;
                break;
                case getOrgChart.NJ_CENTER:f=g=h+(e-h)/2;
                break
            }
            
            break;
            case getOrgChart.RO_LEFT:case getOrgChart.RO_LEFT_PARENT_TOP:h=b._zW;
            m=l=b._zS+(b.h/2);
            j=i;
            switch(d.config.nodeJustification){
                case getOrgChart.NJ_TOP:f=g=h-d.config.levelSeparation/2;
                ...
                case getOrgChart.NJ_BOTTOM:f=g=e+d.config.levelSeparation/2;
                break;
                case getOrgChart.NJ_CENTER:f=g=e+(h-e)/2;
                break
            }
        ...
        switch(d.render){
            case"SVG":switch(d.config.linkType){
                case"M":c.push('&lt;
                path class="link"   d="M'+e+","+i+" "+f+","+j+" "+g+","+l+" L"+h+","+m+'"/&gt;
                ');
                break;
                case"B":c.push('&lt;
                path class="link"  d="M'+e+","+i+" C"+f+","+j+" "+g+","+l+" "+h+","+m+'"/&gt;
                ');
                break
            }
...
getOrgChart.themes={
    annabel:{
        size:[350,140],toolbarHeight:46,textPoints:[{
        ...
        path class="get-box" d="M0 0 L350 0 L350 140 L0 140 Z"/&gt;
        ',text:'&lt;
        text width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]"&gt;
        [text]&lt;
        /text&gt;
        ',image:'&lt;
        image xlink:href="[href]" x="1" y="1" height="138" preserveAspectRatio="xMidYMid slice" width="128"/&gt;
        '
    }
    
    ,belinda:{
        size:[300,300],toolbarHeight:46,textPoints:[{
            x:40,y:70,width:220
        }
        ...
        circle class="get-box" cx="150" cy="150" r="150" /&gt;
        ',text:'&lt;
        text width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]"&gt;
        [text]&lt;
        /text&gt;
        ',image:'&lt;
        clipPath id="get-cut-off-bottom"&gt;
        &lt;
        rect x="0" y="75" width="300" height="150" /&gt;
        &lt;
        /clipPath&gt;
        &lt;
        clipPath clip-path="url(#get-cut-off-bottom)" id="cut-off-bottom"&gt;
        &lt;
        circle cx="150" cy="150" r="150" /&gt;
        &lt;
        /clipPath&gt;
        &lt;
        image preserveAspectRatio="xMidYMid slice"  clip-path="url(#cut-off-bottom)" xlink:href="[href]" x="1" y="1" height="300"   width="300"/&gt;
        '
    }
    
    ,cassandra:{
        size:[310,140],toolbarHeight:46,textPoints:[{
        ...
        path class="get-box" d="M70 10 L70 0 L310 0 L310 10 M310 130 L310 140 L70 140 L70 130"/&gt;
        ',text:'&lt;
        text width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]"&gt;
        [text]&lt;
        /text&gt;
        ',image:'&lt;
        image xlink:href="[href]" x="1" y="20" height="100" preserveAspectRatio="xMidYMid slice" width="100"/&gt;
        '
    }
    
    ,deborah:{
        size:[222,222],toolbarHeight:46,textPoints:[{
            x:10,y:40,width:202
        }
        ...
        &lt;
        path class="get-box" d="M35 0 L187 0 Q222 0 222 35 L222 187 Q222 222 187 222 L35 222 Q0 222 0 187 L0 35 Q0 0 35 0 Z"/&gt;
        &lt;
        /clipPath&gt;
        &lt;
        image clip-path="url(#getVivaClip)" xlink:href="[href]" x="0" y="0" height="222" preserveAspectRatio="xMidYMid slice" width="222"/&gt;
        ',box:'&lt;
        path class="get-text-pane" d="M222 172 Q222 222 187 222 L35 222 Q0 222 0 187 L0 172 Z"/&gt;
        &lt;
        path class="get-text-pane" d="M35 0 L187 0 Q222 0 222 35 L222 50 L0 50 L0 50 Q0 0 35 0 Z"/&gt;
        &lt;
        path class="get-box" d="M35 0 L187 0 Q222 0 222 35 L222 187 Q222 222 187 222 L35 222 Q0 222 0 187 L0 35 Q0 0 35 0 Z"/&gt;
        ',text:'&lt;
        text width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]"&gt;
    ...
    ,lena:{
        size:[481,420],toolbarHeight:46,textPoints:[{
        ...
        linearGradient id="getNodeDef2"&gt;
        &lt;
        stop class="get-def-stop-1" offset="0" /&gt;
        &lt;
        stop class="get-def-stop-2" offset="1" /&gt;
        &lt;
        /linearGradient&gt;
        &lt;
        linearGradient xlink:href="#getNodeDef2" id="getNodeDef1" y2="0.21591" x2="0.095527" y1="0.140963" x1="0.063497" /&gt;
        ',box:'&lt;
        path fill="#000000" fill-opacity="0.392157" fill-rule="nonzero" stroke-width="4" stroke-miterlimit="4" d="M15.266,67.6297 C66.2394,47.802 149.806,37.5153 149.806,37.5153 L387.9,6.06772 L413.495,199.851 C413.495,199.851 427.17,312.998 460.342,367.036 C382.729,399.222 245.307,419.23 245.307,419.23 L51.5235,444.825 L7.74078,113.339 C7.74078,113.339 0.7616,86.8934 15.266,67.6297 L15.266,67.6297 z" /&gt;
        &lt;
        path fill="url(#getNodeDef1)" fill-rule="nonzero" stroke="#000000" stroke-width="4" stroke-miterlimit="4" d="M7.83745,60.562 C66.3108,43.7342 144.877,33.4476 144.877,33.4476 L382.972,2 L408.567,195.783 C408.567,195.783 417.334,271.777 450.506,325.814 C387.314,401.952 240.378,415.162 240.378,415.162 L46.5949,440.757 L2.81219,109.271 C2.81219,109.271 -0.98386,77.3975 7.83744,60.562 L7.83745,60.562 z" /&gt;
        ',text:'&lt;
        text transform="rotate(-8)" width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]"&gt;
        [text]&lt;
        /text&gt;
        ',image:'&lt;
        image transform="rotate(-8)" xlink:href="[href]" x="40" y="150" height="150" preserveAspectRatio="xMidYMid slice" width="280"/&gt;
        '
    }
    
    ,monica:{
        size:[500,220],toolbarHeight:46,textPoints:[{
        ...
        path class="get-box" d="M0 0 L500 0 L500 220 L0 220 Z"/&gt;
        ',text:'&lt;
        text width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]"&gt;
        [text]&lt;
        /text&gt;
        ...
        &lt;
        circle cx="105" cy="65" r="85" /&gt;
        &lt;
        /clipPath&gt;
        &lt;
        image preserveAspectRatio="xMidYMid slice" clip-path="url(#cut-off-bottom)" xlink:href="[href]" x="20" y="-20" height="170" width="170"/&gt;
        '
    }
    ...
    ,eve:{
        ...
        /text&gt;
        ',image:'&lt;
        image xlink:href="[href]" x="20" y="-20" height="170" preserveAspectRatio="xMidYMid slice" width="170"/&gt;
        '
    }
    ...
    ,vivian:{
        ...
        clipPath id="cut-off-bottom"&gt;
        &lt;
        polygon class="get-box" points="20,70 75,-20 185,-20 240,70 185,160 75,160"/&gt;
        &lt;
        /clipPath&gt;
        &lt;
        image preserveAspectRatio="xMidYMid slice" clip-path="url(#cut-off-bottom)" xlink:href="[href]" x="20" y="-20" height="200" width="300"/&gt;
        '
    }
    
    ,helen:{
        size:[380,190],toolbarHeight:46,textPoints:[{
        ...
        text transform="rotate([rotate])"  width="[width]" class="get-text get-text-[index]" x="[x]" y="[y]"&gt;
        [text]&lt;
        /text&gt;
        ',image:'&lt;
        image xlink:href="[href]" x="20" y="0" height="140" preserveAspectRatio="xMidYMid slice" width="350"/&gt;
        '
    }
    ...
    function f(){
        for(var s in b){
            ...
            switch(s.toLowerCase()){
                case"d":var v=j(((n*e)-e)/h)*(b[s][0]-c[s][0])+c[s][0];
                ...
                break;
                default:var u=j(((n*e)-e)/h)*(b[s]-c[s])+c[s];
                for(z=0;
                z&lt;
                a.length;
                z++){
...
get._w._ax=function(a){
    ...
    return a&lt;
    0.5?0.5*Math.pow(2,10*(2*a-1)):0.5*(-Math.pow(2,10*(-2*a+1))+2)
}
...
get._w._as=function(a){
    ...
    return a&lt;
    1?-0.5*(Math.sqrt(1-a*a)-1):0.5*(Math.sqrt(1-((2*a)-2)*((2*a)-2))+1)
}
...
get._w._aw=function(a){
    ...
    return a&lt;
    0.5?0.5*(4*a*a*((2.5949+1)*2*a-2.5949)):0.5*((2*a-2)*(2*a-2)*((2.5949+1)*(2*a-2)+2.5949)+2)
}
...
get._r=function(){
    ...
    var d=/(msie) ([\w.]+)/;
    var c=/(mozilla)(?:.*? rv:([\w.]+))?/;
    var b=f.exec(g)||e.exec(g)||d.exec(g)||g.indexOf("compatible")&lt;
    0&&c.exec(g)||[];
    var a={
    ...
    ;
    getOrgChart._r={
        msie:a.browser=="msie",webkit:a.browser=="webkit",mozilla:a.browser=="mozilla",opera:a.browser=="opera"
    }
...
getOrgChart.prototype._ag=function(c,a){
    ...
    switch(b.keyCode){
        ...
        break;
        case 38:this.move("down");
        break;
        case 39:this.move("right");
        break;
        case 40:this.move("up");
        break;
        case 107:this.zoom(1,true);
        break;
        case 109:this.zoom(-1,true);
        break
    }
...
getOrgChart.util._2=function(f){
    ...
    e++){
        ...
        if(c&&c.length==2&&c[0]===f){
            ...
            while((encodedChar=g.exec(c[1]))!=null&&encodedChar.length&gt;
            1&&encodedChar[1]!=""){
...
getOrgChart.prototype._zb=function(e,a){
    ...
    if(e.nodeName.toLowerCase()!="a"){
        ...
        var b=this._S("clickEvent",{
            id:c.id,parentId:c.pid,data:c.data
        }
...
getOrgChart.prototype._zg=function(c){
    ...
    var b=function(p,j,q){
        ...
        "':"";
        var r="&lt;
        select "+k+'class="get-oc-select-parent"&gt;
        &lt;
        option value="'+p+'"&gt;
        --select parent--&lt;
        /option&gt;
        ...
        l++){
            ...
            if(o.id==p){
                r+='&lt;
                option selected="selected" value="'+o.id+'"&gt;
                '+s+"&lt;
                /option&gt;
                "
            }
...
getOrgChart.prototype._ai=function(b,a){
    ...
    this._aR.dragStart={
        x:this._aR.mouseLastX,y:this._aR.mouseLastY,viewBoxLeft:c[0],viewBoxTop:c[1]
    }
...
getOrgChart.prototype._aA=function(c,b){
    if(c.className.indexOf("get-disabled")&gt;
    -1){
        return false
    }
...
getOrgChart.prototype._k=function(){
    if((this._zw.showIndex&lt;
    this._zw.found.length-1)&&(this._zw.found.length!=0)){
...
getOrgChart.prototype.load=function(){
    ...
    if(a.constructor&&(a.constructor.toString().indexOf("HTML")&gt;
    -1)){
