...
(function ($) {
  ...
  app.UtilityPaneView = app.ActivityPaneView.extend({

    events: {
      'submit #utility-login-form': 'fetchCode',
    ...
    render: function () {
      ...
      this.$el.empty().template('sites/all/modules/custom/mydex_idp_wizard/html/utility-pane-template.html',
        this.model.toJSON()
      );
